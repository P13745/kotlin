    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.Entree.name) {
                ...
                onSelectionChanged = {
                    viewModel.updateItem(newItem = it, previousItem = uiState.entree)
                },
                modifier = Modifier
                )
            }
            composable(route = LunchTrayScreen.Side.name) {
                ...
                onSelectionChanged = {
                    viewModel.updateItem(newItem = it, previousItem = uiState.sideDish)
                },
                modifier = Modifier
                )
            }
            composable(route = LunchTrayScreen.Accompaniment.name) {
                ...
                onSelectionChanged = {
                    viewModel.updateItem(newItem = it, previousItem = uiState.accompaniment)
                },
                modifier = Modifier
                )
            }
