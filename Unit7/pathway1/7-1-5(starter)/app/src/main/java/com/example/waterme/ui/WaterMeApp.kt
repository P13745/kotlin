...
import com.example.waterme.ONE_MINUTES
...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.one_minute, ONE_MINUTES, TimeUnit.SECONDS, plantName),
        Reminder(R.string.two_minutes, TWO_MINUTES, TimeUnit.SECONDS, plantName),
        Reminder(R.string.five_minutes, FIVE_MINUTES, TimeUnit.SECONDS, plantName),
